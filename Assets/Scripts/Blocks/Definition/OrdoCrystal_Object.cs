...
public class OrdoCrystal_Object : BlocklikeObject
{
	...
	public OrdoCrystal_Object(bool isClient){
		...
		this.behaviour = new VisCrystalBehaviour((ushort)BlockID.ORDO_CRYSTAL);

		if(isClient){
			this.go = GameObject.Find("----- PrefabObjects -----/OrdoCrystal_Object");
			this.hitboxObject = GameObject.Find("----- PrefabObjects -----/OrdoCrystal_Object/Hitbox");
