...
public class PineLeaf_Block : Blocks
{
	...
	private ushort assignedWoodCode = (ushort)BlockID.PINE_WOOD;
	private ushort thisCode = (ushort)BlockID.PINE_LEAF;
	private NetMessage reloadMessage;

	public PineLeaf_Block(){
		this.name = "Pine Leaf";
