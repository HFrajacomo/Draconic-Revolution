...
*/
public class SilverWood_Block : Blocks
{
	// Leaves Checker
	...
	int decayDistance = 7;
	ushort assignedLeafCode = (ushort)BlockID.SILVERWOOD_LEAF;
	ushort thisCode = (ushort)BlockID.SILVERWOOD;
	int minDecayTime = 8;
	int maxDecayTime = 30;

	public SilverWood_Block(){
		this.name = "Silverwood";
		this.solid = true;
		this.transparent = 0;
        ...
        this.droppedItem = Item.GenerateItem(ItemID.SILVERWOODBLOCK);
