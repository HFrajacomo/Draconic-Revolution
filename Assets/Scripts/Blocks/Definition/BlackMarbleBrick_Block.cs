...
public class BlackMarbleBrick_Block : Blocks
{
	public BlackMarbleBrick_Block(){
		this.name = "Black Marble Bricks";
		this.solid = true;
		this.transparent = 0;
        ...
        this.droppedItem = Item.GenerateItem(ItemID.BLACKMARBLEBRICKBLOCK);
