...
public class LimestoneBrick_Block : Blocks
{
	public LimestoneBrick_Block(){
		this.name = "Limestone Bricks";
		this.solid = true;
		this.transparent = 0;
        ...
        this.droppedItem = Item.GenerateItem(ItemID.LIMESTONEBRICKBLOCK);
