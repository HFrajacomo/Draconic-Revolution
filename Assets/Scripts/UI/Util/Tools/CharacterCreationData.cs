...
public static class CharacterCreationData {
	...
	private static readonly SkillType[] SKILLS = new SkillType[]{SkillType.ALCHEMY, SkillType.ARTIFICING, SkillType.BLOODMANCY, SkillType.CRAFTING, SkillType.COMBAT,
		...
		SkillType.TRANSMUTING, SkillType.WITCHCRAFT};
