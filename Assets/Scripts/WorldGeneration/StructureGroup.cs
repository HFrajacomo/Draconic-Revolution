...
public static class StructureGroup
{
    ...
    private static void PopulateAuraFew(){
        visFew.Add(new StructSpawn(StructureCode.SingleIgnisAuraCrystal, 2, 1f, 10, -1, true, 0));
        visFew.Add(new StructSpawn(StructureCode.SingleAquaAuraCrystal, 2, 1f, 10, -1, true, 0));
        visFew.Add(new StructSpawn(StructureCode.SingleVentusAuraCrystal, 2, 1f, 10, -1, true, 0));
        visFew.Add(new StructSpawn(StructureCode.SingleSolumAuraCrystal, 2, 1f, 10, -1, true, 0));
        visFew.Add(new StructSpawn(StructureCode.SingleCastusAuraCrystal, 2, 1f, 10, -1, true, 0));
        visFew.Add(new StructSpawn(StructureCode.SingleRuinaAuraCrystal, 2, 1f, 10, -1, true, 0));
        visFew.Add(new StructSpawn(StructureCode.SingleMagicAuraCrystal, 2, 1f, 10, -1, true, 0));
    }

    private static void PopulateAuraMany(){
        visFew.Add(new StructSpawn(StructureCode.SingleIgnisAuraCrystal, 5, 1f, 10, -1, true, 0));
        visFew.Add(new StructSpawn(StructureCode.SingleAquaAuraCrystal, 5, 1f, 10, -1, true, 0));
        visFew.Add(new StructSpawn(StructureCode.SingleVentusAuraCrystal, 5, 1f, 10, -1, true, 0));
        visFew.Add(new StructSpawn(StructureCode.SingleSolumAuraCrystal, 5, 1f, 10, -1, true, 0));
        visFew.Add(new StructSpawn(StructureCode.SingleCastusAuraCrystal, 5, 1f, 10, -1, true, 0));
        visFew.Add(new StructSpawn(StructureCode.SingleRuinaAuraCrystal, 5, 1f, 10, -1, true, 0));
        visFew.Add(new StructSpawn(StructureCode.SingleMagicAuraCrystal, 5, 1f, 10, -1, true, 0));
    }
}
